import pytest
from src.widget import type_card_and_account_number, datatime


@pytest.mark.parametrize('name_and_masks, expected', [("Maestro 1596837868705199", "Maestro 1596 83** **** 5199"),
